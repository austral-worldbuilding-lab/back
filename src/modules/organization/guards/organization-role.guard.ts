...
@Injectable()
export class OrganizationRoleGuard extends BaseOrganizationRoleGuard {
  ...
  protected extractOrganizationId(
    ...
    const organizationId =
      ...
      (request.params as { organizationId?: string; id?: string })
        ?.organizationId ||
      (request.params as { organizationId?: string; id?: string })?.id ||
